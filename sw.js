...
const CACHE = "weekly-focus-v88c";
const ASSETS = [
  "./", "./index.html",
  "./js/config.js", "./js/akatsuki-client.js", "./js/wf-purchase-adapter.js", "./js/weekly-focus-app.js", "./js/info-feeds.js", "./js/wf-cc-bridge-v2.js",
  "./css/weekly-focus.css", "./css/home-screens.css", "./css/wf-login.css", "./js/wf-login.js",
